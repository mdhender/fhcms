...
struct star_data {
    ...
    char  ttype;                 /* Dwarf, degenerate, main sequence or giant. */
...
struct species_data {
    ...
    char  govt_ttype[32];                /* Type of government. */
...
const MAX_ITEMS    38 /* Always bump this up to a multiple of two.
